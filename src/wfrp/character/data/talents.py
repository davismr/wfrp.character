...
BASIC_TALENTS = {
    ...
    "Acute Sense": {
        ...
        "description": (
            ...
            "imperceptible details with the associated sense, as dictated by the GM. "
            "This could include: seeing an eagle beyond everyone else’s eyeshot, "
            "smelling an almost odourless poison, hearing the breath of an unmoving "
            "mouse within a wall, feeling a worn away letter in a carving, or tasting "
            "that two beers from the same brewer have been drawn from two different "
            "barrels."
        ),
        "specialisations": [
            "Touch",
    ...
    "Ambidextrous": {
        ...
        "description": (
            ...
            "solely on your secondary hand, not –20. If you have this Talent twice, "
            "you suffer no penalty at all."
        ),
    },
    "Animal Affinity": {
        "max": "Willpower Bonus",
        ...
        "description": (
            ...
            "will automatically be calm in your presence unless they have a reason not "
            "to be, such as pain, an attack, being naturally hyper-aggressive, or "
            "having nearby young."
        ),
    },
    "Arcane Magic": {
    ...
    "Artistic": {
        ...
        "description": (
            ...
            "uses, ranging from creating Wanted Posters to sketching accurate "
            "journals, and has spot benefits as determined by the GM. Further to this, "
            "add Art (Any) to any Career you enter; if it is already in Career, you "
    ...
    "Attractive": {
        ...
        "description": (
            ...
            "gods gave you. When you successfully use Charm to influence those "
            "attracted to you, you can choose to either use your rolled SL, or the "
            "number rolled on your units die. So, a successful roll of 38 could be "
            "used for +8 SL."
        ),
    },
    "Battle Rage": {
        ...
        "short_description": "",
        "description": (
            "You are better able to control your Frenzy in combat. You can end your "
            "Frenzy with a successful Cool Test at the end of the round."
        ),
    },
    "Beat Blade": {
        ...
        "description": (
            ...
            "Melee Test; if successful, your opponent loses –1 Advantage, and loses a "
            "further –1 per SL you score. This Test is not Opposed. This Talent is of "
            "no use if your opponent has no weapon, or has a larger Size than you "
            "(see page 341)."
        ),
    },
    "Beneath Notice": {
        ...
        "description": (
            ...
            "an incongruous position, those of a higher Status Tier will normally "
            "ignore you unless your presence becomes inappropriate, which can make it "
            "very easy to listen into conversations you perhaps shouldn’t. Further, "
            "characters with a higher Status Tier than you gain no Advantage for "
            "striking or wounding you in combat, as there is nothing to be gained for "
    ...
    "Berserk Charge": {
        ...
        "description": (
            ...
            "+1 Damage to all Melee attacks per level in this Talent."
        ),
    },
    "Blather": {
        "max": "Fellowship Bonus",
    ...
    "Break and Enter": {
        ...
        "description": (
            ...
            "against inanimate objects such as windows, chests, doors, and similar."
        ),
    },
    "Briber": {
        "max": "Fellowship Bonus",
    ...
    "Cardsharp": {
        ...
        "description": (
            ...
            "Hand when playing cards, you can choose to either use your rolled SL, or "
            "the number rolled on your units die. So, a successful roll of 28 could be "
            "used for +8 SL. If you play a real card game to represent what is "
            "happening in-game, you may receive an extra number of cards per deal "
            "equal to your level in Cardsharp, then discard down to the appropriate "
            "hand-size before each round of play."
        ),
    },
    "Careful Strike": {
        "max": "Initiative Bonus",
        "description": (
            ...
            "+/–10 per time you have this Talent. So, if you had this Talent twice and "
            "hit location 34, the Right Arm, you could modify this down to 14, the "
            "Left Arm, or up to 54, the Body (see page 159)."
        ),
    },
    "Carouser": {
        "max": "Toughness Bonus",
    ...
    "Catfall": {
        ...
        "description": (
            ...
            "Athletics Test. If successful, reduce the distance fallen by 1 yard, +1 "
            "extra yard per +1 SL scored, for the purposes of calculating Damage."
        ),
    },
    "Cat-tongued": {
        "max": "Fellowship Bonus",
        ...
        "description": (
            ...
            "your Charm with their Intuition to detect if there is something fishy in "
            "what you say."
        ),
    },
    "Chaos Magic": {
        ...
        "description": (
            ...
            "and gain a Corruption point. For more about the available spells, see "
            "Chapter 8: Magic. Under normal circumstances, you may only ever know one "
            "Lore of Chaos Magic."
        ),
    },
    "Combat Aware": {
        ...
        "description": (
            ...
            "Test to ignore Surprise, which is modified by circumstance as normal."
        ),
    },
    "Combat Master": {
        "max": "Agility Bonus",
        "description": (
            ...
            "person for the purposes of determining if one side outnumbers the other. "
            "This Talent only comes into play when you are out-numbered. See page 162 "
            "for the rules for out-numbering."
        ),
    },
    "Combat Reflexes": {
        "max": "Initiative Bonus",
    ...
    "Commanding Presence": {
        ...
        "description": (
            ...
            "Leadership tests with their Willpower. Of course, enemies are still no "
            "more likely to respect or obey you, but the common folk rarely stand "
            "against you."
        ),
    },
    "Concoct": {
        ...
        "description": (
            ...
            "need of a Workshop. Other Crafting Endeavours use the normal rules."
        ),
    },
    "Contortionist": {
        "max": "Agility Bonus",
    ...
    "Craftsman": {
        ...
        "description": (
            ...
            "instead purchase the Skill for 5 XP fewer per Advance."
        ),
        "specialisations": [
            "Apothecary",
            "Calligrapher",
    ...
    "Deadeye Shot": {
        ...
        "description": (
            ...
            "Location is struck with your ranged weapons, you may pick a location."
        ),
    },
    "Dealmaker": {
        "max": "Fellowship Bonus",
    ...
    "Detect Artefact": {
        ...
        "description": (
            ...
            "sense the item is magical; further, each SL also provides a specific "
            "special rule the item uses, if it has any. Normally, you may only attempt "
            "this Test once per artefact touched."
        ),
    },
    "Diceman": {
        "max": "Intelligence Bonus",
        ...
        "description": (
            ...
            "you can choose to either use your rolled SL, or the number rolled on your "
            "units die. So, a successful roll of 06 could be used for +6 SL. If you "
            "play any real-life dice games to represent in-game dice games, always "
            "roll extra dice equal to your Diceman level and choose the best results."
        ),
    },
    "Dirty Fighting": {
        "max": "Weapon Skill Bonus",
        ...
        "description": (
            ...
            "any successful Melee (Brawling) hit."
        ),
    },
    "Disarm": {
        "max": "Initiative Bonus",
    ...
    "Distract": {
        ...
        "description": (
            ...
            "Distraction. This is resolved by an Opposed Athletics/Cool Test. If you "
            "win, your opponent can gain no Advantage until the end of the next Round."
        ),
    },
    "Doomed": {
        "max": 1,
        ...
        "description": (
            ...
            "Dooming. In conjunction with your GM, come up with a suitable Dooming. "
            "Should your character die in a fashion that matches your Dooming, your "
            "next character gains a bonus of half the total XP your dead character "
            "accrued during play."
        ),
    },
    "Drilled": {
        ...
        "description": (
            ...
            "ally with the Drilled Talent, you may keep 1 lost Advantage for each time "
            "you’ve taken the Drilled Talent."
        ),
    },
    "Dual Wielder": {
        "max": "Agility Bonus",
        ...
        "description": (
            ...
            "determine Damage as normal, but remember to keep your dice roll, as you "
            "will use it again. If the first strike hits, once it is resolved, the "
            "weapon in your secondary hand can then target an available opponent of "
            "your choice using the same dice roll for the first strike, but reversed. "
            "So, if you rolled 34 to hit with the first weapon, you use 43 to hit with "
            "the second. Remember to modify this second roll by your off-hand penalty "
            "(–20 unless you have the Ambidextrous Talent). This second attack is "
            "Opposed with a new defending roll, and damage for this second strike is "
            "calculated as normal. The only exception to this is if you roll a "
            "Critical for your first strike. If this happens, use the roll on the "
            "Critical Table to also act as the roll for the second attack. So, if you "
            "scored a critical to the head and rolled 56 on the Critical table for a "
            "Major Eye Wound, your second attack would then strike out with a to-hit "
            "value of 56. If you choose to attack with both weapons, all your "
            "defensive rolls until the start of your next Turn suffer a penalty of "
            "–10. You do not gain an Advantage when you successfully strike or Wound "
            "an opponent when Dual Wielding unless both attacks hit."
        ),
    },
    "Embezzle": {
        "max": "Intelligence Bonus",
        ...
        "description": (
            ...
            "performing an Income Endeavour), you may attempt an Opposed Intelligence "
            "Test with your employer (assuming you have one). If you win, you skim "
            "2d10 + SL brass pennies, 1d10 + SL silver shillings, or 1 + SL gold "
            "crowns (depending upon the size of the business in question, as "
            "determined by the GM) without being detected. If your employer wins by "
            "6+ SL, you gain the money, but your embezzling is detected; what then "
            "happens is left to the GM. Any other result means you have failed to "
            "embezzle any money."
        ),
    },
    "Enclosed Fighter": {
        ...
        "description": (
            ...
            "tunnels, the frontline, small fighting pits, and similar, and can use the "
            "Dodge Skill, even if it would normally be disallowed due to lack of space."
        ),
    },
    "Etiquette": {
        "max": "Fellowship Bonus",
        ...
        "description": (
            ...
            "are: Criminals, Cultists, Guilders, Nobles, Scholars, Servants, and "
    ...
    "Fast Hands": {
        ...
        "description": (
            ...
            "instead they only get to Oppose your Sleight of Hand Tests if they "
            "actively suspect and are looking for your movements. Further, attempts "
            "to use Melee (Brawling) to simply touch an opponent gain a bonus of +10 "
            "× your level in Fast Hands."
        ),
    },
    "Fast Shot": {
        "max": "Agility Bonus",
        ...
        "description": (
            ...
            "Round. You roll to hit using all the normal modifiers. Employing Fast "
            "Shot requires both your Action and Move for your upcoming turn, and these "
            "will count as having been spent when your next turn arrives. If two or "
            "more characters use Fast Shot, the character who has taken this Talent "
            "most goes first. If any characters have taken Fast Shot an equal number "
            "of times, both shots are fired simultaneously, and should both be handled "
            "at the same time."
        ),
    },
    "Fearless": {
    ...
    "Feint": {
        ...
        "description": (
            ...
            "using a weapon. This is resolved with an Opposed Melee (Fencing)/Melee "
            "Test. If you win, and you attack the same opponent before the end of the "
            "next Round, you may add the SL of your Feint to your attack roll."
        ),
    },
    "Field Dressing": {
        "max": "Intelligence Bonus",
        ...
        "description": (
            ...
            "however, if you do so, you may not score more than +1 SL as you focus on "
            "speed over accuracy."
        ),
    },
    "Fisherman": {
        ...
        "description": (
            ...
            "assumed to be able to fish enough to feed yourself and a number of others "
            "equal to your level in Fisherman, assuming you choose to spend at least "
            "an hour or so with a line and bait. You may secure more fish in addition "
            "to this using the normal rules for foraging (see page 127)."
        ),
    },
    "Flagellant": {
        "max": "Toughness Bonus",
        ...
        "description": (
            ...
            "Wounds suffered equal to your level in Flagellent. Until you next sleep, "
            "if you have the Frenzy Talent you may enter Frenzy immediately without "
            "testing."
        ),
    },
    "Flee!": {
    ...
    "Furious Assault": {
        ...
        "description": (
            ...
            "in close combat, you may immediately spend an Advantage or your Move to "
            "make an extra attack (assuming you have your Move remaining)."
        ),
    },
    "Gregarious": {
        "max": "Fellowship Bonus",
    ...
    "Hatred": {
        ...
        "description": (
            ...
            "group. Examples you could take include: Beastmen, Greenskins, Monsters, "
            "Outlaws, Sigmarites, Undead, Witches."
        ),
        "specialisations": [
            "Beastmen",
            "Greenskins",
    ...
    "Holy Visions": {
        ...
        "description": (
            ...
            "Test to receive visions (often obscure, and seen through the paradigm of "
            "your cult or individual belief-system) regarding the local area if "
    ...
    "In-fighter": {
        ...
        "description": (
            ...
            "Further, if you use the optional rules for In-fighting (see page 297), "
            "gain a bonus of +10 to hit your opponent."
        ),
    },
    "Inspiring": {
        "max": "Fellowship Bonus",
        ...
        "description": (
            ...
            "Leadership Skill (see page 126) when at war."
        ),
    },
    "Instinctive Diction": {
        "max": "Initiative Bonus",
        ...
        "description": (
            ...
            "suffer a Miscast if you roll a double on a successful Language (Magick) "
            "Test."
        ),
    },
    "Invoke": {
        ...
        "description": (
            ...
            "you currently know. So, if you already know 3 miracles, your next miracle "
            "costs 300 XP to purchase. Full rules for learning new miracles are "
            "provided in Chapter 7: Religion and Belief. Under normal circumstances, "
            "you may not learn more than one Invoke (Divine Lore) Talent. Further, "
            "you may not learn the Petty Magic or Arcane Magic Talents when you have "
            "the Invoke Talent. You can unlearn this Talent for 100 XP, but will lose "
    ...
    "Iron Jaw": {
        ...
        "description": (
            ...
            "immediate Challenging (+0) Endurance Test to not take one of them, with "
    ...
    "Iron Will": {
        ...
        "description": (
            ...
            "and will not stop you speaking out against the intimidating party."
        ),
    },
    "Jump Up": {
        "max": 1,
        "description": (
            ...
            "This Athletics Test is often modified by the Strength behind the blow "
            "that knocks you down: for every +10 Strength the blow has over your "
            "Toughness, you suffer a penalty of –10 to the Athletics Test, and vice "
            "versa."
        ),
    },
    "Kingpin": {
    ...
    "Linguistics": {
        ...
        "description": (
            ...
            "with a successful Intelligence Test (which can be attempted once per "
            "month). Note: Linguistics only works for languages used to frequently "
    ...
    "Mimic": {
        ...
        "description": (
            ...
            "a day with an Initiative Test; this Test may be attempted once per day. "
            "Once passed, you may always mimic the accent, and locals will believe you "
    ...
    "Night Vision": {
        ...
        "description": (
            ...
            "you can see clearly for 20 yards per level of Night Vision. Further, you "
            "can extend the effective illumination distance of any light sources by 20 "
            "yards per level of Night Vision."
        ),
    },
    "Nimble Fingered": {
        "max": 1,
    ...
    "Noble Blood": {
        ...
        "description": (
            ...
            "considered of higher Status than others unless they also have the Noble "
            "Blood Talent, where Status is compared as normal."
        ),
    },
    "Nose for Trouble": {
        "max": "Initiative Bonus",
        ...
        "description": (
            ...
            "seeking to cause you harm, even if normally you would not be allowed a "
            "Test (because of Talents or a Spell, for example). This Test will likely "
            "be Opposed if others are hiding, and the GM may prefer to take this Test "
            "on your behalf in secret so you do not know the results should you fail. "
            "If any troublemakers you spot start combat, you may ignore any Surprised "
            "Condition they would normally inflict."
        ),
    },
    "Numismatics": {
        "max": "Initiative Bonus",
        ...
        "description": (
            ...
            "by experience alone, not even requiring a Test. Further, you can identify "
            "forged coins with a Simple Evaluate Test; it is never Opposed by the SL "
            "of the Forger."
        ),
    },
    "Old Salt": {
        ...
        "description": (
            ...
            "rolling ships, and similar. Further, you count as two seamen towards the "
            "minimum number of crew to pilot a sea-going vessel."
        ),
    },
    "Orientation": {
        "max": "Initiative Bonus",
    ...
    "Panhandle": {
        ...
        "description": (
            ...
            "when Begging, not every hour (see page 120)."
        ),
    },
    "Perfect Pitch": {
        "max": "Initiative Bonus",
    ...
    "Petty Magic": {
        ...
        "description": (
            ...
            "and permanently memorise, a number of spells equal to your Willpower "
            "Bonus."
        ),
    },
    "Pharmacist": {
        ...
        "description": (
            ...
            "Trade (Apothecary) test if this allows the Test to succeed."
        ),
    },
    "Pilot": {
        "max": "Initiative Bonus",
        ...
        "description": (
            ...
            "will score a success; however, if you do so, you may not score more than "
            "+1 SL as you catch the incoming danger at the last moment."
        ),
    },
    "Public Speaker": {
        "max": "Fellowship Bonus",
        ...
        "description": (
            ...
            "with your Charm Skill (see page 120) when Public Speaking."
        ),
    },
    "Pure Soul": {
        "max": "Willpower Bonus",
        "description": (
            ...
            "having to Test to see if you become corrupt."
        ),
    },
    "Rapid Reload": {
        "max": "Dexterity Bonus",
    ...
    "Reaction Strike": {
        ...
        "description": (
            ...
            "Challenging (+0) Initiative Test to gain an immediate Free Attack outside "
            "the normal turn sequence. This attack is resolved with whatever weapon "
            "you are carrying in your primary hand. You may make as many Reaction "
            "Strikes in a Round as you have levels in this Talent, but can only attack "
            "each individual charger once each."
        ),
    },
    "Read/Write": {
        "max": 1,
    ...
    "Relentless": {
        ...
        "description": (
            ...
            "keep a number of Advantage equal to your level of Relentless. Further, "
            "you may use Advantage to Disengage even if you have lower Advantage than "
            "your opponents."
        ),
    },
    "Resistance": {
        ...
        "description": (
            ...
            "threat, such as Magic, Poison, Disease, Mutation, every session. If SL is "
            "important, use your Toughness Bonus as SL for the Test."
        ),
    ...
    "Reversal": {
        ...
        "description": (
            ...
            "instead of gaining +1 Advantage, you may take all your opponent’s Current "
            "Advantage. If you do this, you do not cause any Damage, even if it is "
            "your Turn in the Round."
        ),
    },
    "Riposte": {
        "max": "Agility Bonus",
        ...
        "description": (
            ...
            "has the Fast quality, you may cause Damage when you are attacked, just as "
            "if it was your Action. You can Riposte a number of attacks per round "
            "equal to your Riposte level."
        ),
    },
    "River Guide": {
        "max": "Initiative Bonus",
        ...
        "description": (
            ...
            "Difficulty for doing so is –10 or lower — you automatically pass all "
            "Tests easier than this. Further, if you have the appropriate Lore (Local) "
            "Skill, you need never Test for navigating dangerous waters — you are "
            "assumed to know the route through."
        ),
    },
    "Robust": {
        "max": "Toughness Bonus",
        "description": (
            ...
            "even if the Damage cannot normally be reduced, but still suffer a minimum "
            "of 1 Wound from any Damage source."
        ),
    },
    "Roughrider": {
        "max": "Agility Bonus",
        ...
        "description": (
            ...
            "conflict. Assuming you have the Ride skill, you can direct your mount to "
            "take an Action, not just a Move, without a Ride test."
        ),
    },
    "Rover": {
        "max": "Agility Bonus",
    ...
    "Scale Sheer Surface": {
        ...
        "description": (
            ...
            "walls, and similar, and you ignore any penalties to Climb Tests derived "
            "from the difficulty of the surface climbed."
        ),
    },
    "Schemer": {
        "max": "Intelligence Bonus",
        ...
        "description": (
            ...
            "situation or entangled web of social connections; the GM will perform a "
            "secret Intelligence Test and provide you some observations regarding the "
            "situation based upon your SL."
        ),
    },
    "Sea Legs": {
        "max": "Toughness Bonus",
        ...
        "description": (
            ...
            "sea, you need never Test to see if you become Sea Sick. At other times "
            "(such as a storm, or a magically induced bout of Sea Sickness), you can "
            "ignore any penalties to Tests to avoid Sea Sickness."
        ),
    },
    "Seasoned Traveller": {
        "max": "Intelligence Bonus",
        ...
        "description": (
            ...
            "it is already in Career, you may purchase the Skill, both times — a "
            "different Speciality each time, such as Altdorf, Vorbergland, or "
            "Ubersreik — for 5 XP fewer per Advance."
        ),
    },
    "Second Sight": {
        "max": "Initiative Bonus",
    ...
    "Secret Identity": {
        ...
        "description": (
            ...
            "Career. As long as you are dressed appropriately, you may use the Social "
            "Status of the chosen Career you masquerade as rather than your own for "
            "modifying Fellowship Tests, and can even ignore the Criminal Talent. "
            "However, maintaining this identity will require Entertain (Acting) rolls "
            "when you encounter those who may recognise your falsehood. You may create "
            "a new Secret Identity for each level you have in this Talent."
        ),
    },
    "Shadow": {
        "max": "Agility Bonus",
        ...
        "description": (
            ...
            "Instead you test against just your Perception or your Stealth Skill, "
            "whichever is higher."
        ),
    },
    "Sharp": {
    ...
    "Sixth Sense": {
        ...
        "description": (
            ...
            "will normally come after a secret Intuition Test on your behalf. Further, "
            "you may ignore Surprise if you pass an Intuition Test."
        ),
    },
    "Slayer": {
        "max": 1,
        "description": (
            ...
            "rules modify your Strength or Strength Bonus. Further, if your target is "
            "larger than you, and your score a Critical (see page 159), multiply all "
            "melee Damage you cause by the number of steps larger your target is "
            "(so, 2 steps = ×2, 3 steps = ×3, and so on); this multiplication is "
            "calculated after all modifiers are applied. See page 341 for more about "
            "Size."
        ),
    },
    "Small": {
    ...
    "Sniper": {
        ...
        "description": (
            ...
            "penalties for shooting at Long range, and half the penalties for Extreme "
            "range."
        ),
    },
    "Speedreader": {
        ...
        "description": (
            ...
            "important during combat, a successful Language Test lets you read and "
            "fully comprehend a number of pages per Round equal to your SL plus "
            "Speedreader level (minimum of 1, even if you fail the Test)."
        ),
    },
    "Sprinter": {
        "max": "Strength Bonus",
    ...
    "Step Aside": {
        ...
        "description": (
            ...
            "up to 2 yards as you dive away, and no longer count as Engaged. None of "
            "your opponents will gain a Free Attack when you do this."
        ),
    },
    "Stone Soup": {
        "max": "Toughness Bonus",
        ...
        "description": (
            ...
            "penalties (bar feeling really hungry), and need only test for Starvation "
            "every 3 days, not 2 (see page 181)."
        ),
    },
    "Stout-hearted": {
        "max": "Willpower Bonus",
        ...
        "description": (
            ...
            "of your Turns as well as at the end of the Round (see page 168 for more "
            "on this)."
        ),
    },
    "Strider": {
        ...
        "description": (
            ...
            "Typical specialities include: Coastal, Deserts, Marshes, Rocky, Tundra, "
            "Woodlands."
        ),
        "specialisations": [
            "Coastal",
    ...
    "Strike to Stun": {
        ...
        "description": (
            ...
            "weapon with the Pummel Quality (see page 298). Further, you count all "
            "improvised weapons as having the Pummel Quality."
        ),
    },
    "Strong Back": {
        "max": "Strength Bonus",
        ...
        "description": (
            ...
            "additional Encumbrance points of trappings (see page 293) equal to your "
            "level of Strong Back."
        ),
    },
    "Strong Legs": {
        "max": "Strength Bonus",
    ...
    "Strong Swimmer": {
        ...
        "description": (
            ...
            "your Toughness Bonus for the purposes of holding your breath."
        ),
    },
    "Sturdy": {
        "max": "Strength Bonus",
    ...
    "Super Numerate": {
        ...
        "description": (
            ...
            "represent what your PC is capable of mentally computing."
        ),
    },
    "Supportive": {
        "max": "Fellowship Bonus",
        ...
        "description": (
            ...
            "with a higher Status tier, you can choose to either use your rolled SL, "
            "or the number rolled on your units die. So, a successful roll of 46 could "
            "be used for +6 SL."
        ),
    },
    "Sure Shot": {
    ...
    "Surgery": {
        ...
        "description": (
            ...
            "can also perform surgery to resolve internal issues with an Extended "
            "Challenging (+0) Heal Test with a target SL determined by the GM "
            "(usually 5–10) depending upon the difficulty of the procedure at hand. "
            "This will cause 1d10 Wounds and 1 Bleeding Condition per Test, meaning "
            "surgery has a high chance of killing a patient if the surgeon is not "
            "careful. After surgery, the patient must pass an Average (+20) Endurance "
            "Test or gain a Minor Infection (see page 187)."
        ),
    },
    "Tenacious": {
        "max": "Toughness Bonus",
        ...
        "description": (
            ...
            "a hardship. This includes enduring prolonged riding, exposure, rituals, "
            "and similar adversities."
        ),
    },
    "Tinker": {
        "max": "Dexterity Bonus",
    ...
    "Tower of Memories": {
        ...
        "description": (
            ...
            "of Memories allows you to perfectly recall a sequence of facts by storing "
            "them in an imaginary spire. You can recall a sequence as long as your "
            "Intelligence without having to make a Test. For every 10 more items you "
            "attempt to memorise, you must make an increasingly difficult Intelligence "
            "Test to recall the list correctly, starting at Very Easy (+60) for +10, "
            "Easy (+40) for +20, Average (+20) for +30, and so on. Beyond it’s obvious "
            "utility for Gamble Tests, where having this Talent adds a bonus of +20 to "
            "+60 depending upon how useful recalling sequences is to the game at hand, "
            "the GM can apply bonuses to other Tests as appropriate. Each time you "
            "take this Talent you may recall an extra sequence without having to "
            "forget a previously stored one."
        ),
    },
    "Trapper": {
        "max": "Initiative Bonus",
        ...
        "description": (
            ...
            "intention; the GM may prefer to make some of these Tests on your behalf "
            "in private."
        ),
    },
    "Trick Riding": {
        ...
        "description": (
            ...
            "Further, when mounted, you can make your Move at the start of the Round "
            "instead of on your Turn."
        ),
    },
    "Tunnel Rat": {
        "max": "Agility Bonus",
        ...
        "description": (
            ...
            "passive Perception Tests to detect you; they can only spot you if they "
    ...
    "Unshakeable": {
        ...
        "description": (
            ...
            "Condition if you are successfully wounded by a Blackpowder weapon, not "
            "just if you are shot at."
        ),
    },
    "Very Resilient": {
        "max": 1,
    ...
    "War Leader": {
        ...
        "description": (
            ...
            "Leader to their SL in one Willpower Test per Round. This bonus does not "
            "stack."
        ),
    },
    "War Wizard": {
        ...
        "description": (
            ...
            "without using your Action. However, if you do this, you may not cast "
    ...
    "Waterman": {
        ...
        "description": (
            ...
            "derived from rolling waters, swaying vessels, unsure footing, and "
            "similar. Further, you count as two boatmen towards the minimum number of "
            "crew to pilot a river vessel."
        ),
    },
    "Wealthy": {
        "max": None,
    ...
    "Well-prepared": {
        ...
        "description": (
            ...
            "the trapping required for the current situation from your backpack "
            "(or similar) as long as it is Encumbrance 0, could feasibly been bought "
            "recently, and doesn’t stretch credibility too far. This could be anything "
            "from a flask of spirits to fortify a wounded comrade to a pfennig-whistle "
            "needed by a passing entertainer. Whenever you do this, you must deduct "
            "the cost for the prepared item from your purse, representing the coin you "
            "spent earlier."
        ),
    },
    "Witch!": {
        ...
        "description": (
            ...
            "the Skill for 5 XP fewer per Advance. Further, you may spend 1 Resilience "
            "point to immediately cast any spell as if it were one of your Arcane Lore "
            "spells; you also instantly memorise that spell as one of your Arcane Lore "
            "spells for 0 XP. You can do this a number of times equal to your level in "
            "this Talent."
        ),
    },
}
...
SEA_OF_CLAWS_TALENTS = {
    ...
    "Master and Commander": {
        ...
        "tests": "Leadership",
        "description": (
            "You are respected and trusted by your crew. Any appropriate Leadership "
