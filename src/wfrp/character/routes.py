def includeme(config):
    ...
    config.add_route("religion", "/character/{id}/religion")
    ...
    config.add_route("experience-talent", "/character/{id}/experience-talent")
    ...
    config.add_route("character-update", "/character/{id}/update")
